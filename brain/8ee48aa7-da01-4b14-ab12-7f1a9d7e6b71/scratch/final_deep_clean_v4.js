...
console.log("Performing global deep cleaning (tags)...");
content = content
...
console.log("Adding placeholder to Protocol 2.1...");
...
console.log("Final Mojibake repair...");
content = content
    .replace(/Ã¡/g, 'á')
    .replace(/Ã©/g, 'é')
    .replace(/Ã­/g, 'í')
...
// Specific fixes for the symbols seen in tail
content = content.replace(//g, ''); // Remove replacement chars if any

fs.writeFileSync(dataPath, content, 'utf8');
console.log("Deep cleaning v4 completed successfully.");
